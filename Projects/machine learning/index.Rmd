...
We plot out both specificity versus sensitivity for all four models.The figure shows random forest is better in both aspects. Therefore, in the final test, we will only use random forest.
